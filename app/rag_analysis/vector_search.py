...
from app.rag_analysis.keyword_booster import calculate_keyword_boost
...
class VectorSearch:
    ...
    def hybrid_search(self, query: str, document_weight: float = 0.3,
        ...
        try:
            ...
            doc_results = self.search_documents(query, limit=candidate_limit, threshold=self.similarity_threshold)

            # Get chunk results
            chunk_results = self.search_chunks(query, limit=candidate_limit, threshold=self.similarity_threshold)
